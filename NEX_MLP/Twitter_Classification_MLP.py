...
def predict(dataset="", n_hidden=500, n_in=0, n_out=0):
    datasets,n_in,n_out = load_data2(dataset,readType="T")
...
if __name__ == '__main__':
    dataset='simuTW_3Class_500Fea_50002.pkl.zip'
    dataset=["simuTW_3Class_300Fea_5000"+str(i)+".pkl.zip" for i in range(1,4)]
