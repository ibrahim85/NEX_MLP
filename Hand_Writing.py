...
# Load the dataset
#f = gzip.open('twitterSimuData96Fea3Class500_small.pkl.zip', 'rb')
#print cPickle.load(f)
zfile = zipfile.ZipFile("twitterSimuData3Class500Fea_small.pkl.zip","r")
for finfo in zfile.infolist():
    ifile = zfile.open(finfo)
    train_set, valid_set, test_set = cPickle.load(ifile)
