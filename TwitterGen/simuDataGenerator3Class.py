...
fileName="twitterSimuData96Fea3Class.pkl"
data_str= pickle.dump(data,open(fileName,"w"))
with zipfile.ZipFile("../handWritingEx/"+fileName+".zip", 'w', zipfile.ZIP_DEFLATED) as myzip:
